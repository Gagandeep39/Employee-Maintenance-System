...
public class DataRepository {
	...
	private static void prepareHashMap() {
		...
		User u3 = new User("gagan", "123456", UserType.Employee);
...
//		employeeMap.put(e1.getEmpId(), e1);
		...
		LeaveHistory l1 = new LeaveHistory(e2.getEmpId(), 12, 3, LocalDate.parse("2020-04-12"), LocalDate.parse("2020-04-15"), LeaveStatus.Applied);
